      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/resume.pdf" render={() => {
             window.open('https://https://master.d15x40ji9kfba4.amplifyapp.com/resume.pdf'); return <Redirect to="/resume"/>;  // after opening pdf in new tab, redirect so original page still shows resume
          }} />
