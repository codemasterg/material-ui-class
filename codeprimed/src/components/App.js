      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/resume.pdf" render={() => {
             window.open('https://master.d162hchzdrk4o4.amplifyapp.com/3000/resume.pdf'); return <Redirect to="/resume"/>;  // after opening pdf in new tab, redirect so original page still shows resume
          }} />
