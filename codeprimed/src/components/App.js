      ...
      <BrowserRouter>
        ...
        <Switch>
          ...
          <Route exact path="/resume.pdf" render={() => {
             window.open('https://' + window.location.hostname + '/resume.pdf'); return <Redirect to="/resume"/>;  // after opening pdf in new tab, redirect so original page still shows resume
          }} />
